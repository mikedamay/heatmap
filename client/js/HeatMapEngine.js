(function() {
    ...
    document.hmcontext.newEngine = function newEngine() {
...
//        document.writeln( str + "<br>" );
        ...
        exposeMembersForUnitTests(0 /*this.length*/, arguments, xpublic, xprivate);
                // TODO would ideally use aregs.length here.  - the 'this' problem gets in the way.
                // The call to the newEngine function is qualified by document.hmcontext which makes this.length undefined.
                // presumably when 'this' referred to a free function it worked whereas document.hmcontext
                // has no such member as 'length'
        return xpublic;
    };
})();
